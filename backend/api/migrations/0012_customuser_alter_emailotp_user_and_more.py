...
def copy_users_to_customuser(apps, schema_editor):
    """Copy existing User data to CustomUser model"""
    CustomUser = apps.get_model('api', 'CustomUser')
    
    for user in User.objects.all():
        # Create CustomUser with same data
        custom_user = CustomUser.objects.create(
            id=user.id,  # Keep same ID for foreign key relationships
        ...
        custom_user.user_permissions.set(user.user_permissions.all())


class Migration(migrations.Migration):

    dependencies = [
        ('api', '0011_task_notified_overdue'),
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to='api.customuser'),
        ),
        migrations.AlterField(
            model_name='pushsubscription',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='push_subscriptions', to='api.customuser'),
        ),
        migrations.AlterField(
            model_name='task',
            name='user',
        ...
        migrations.AlterField(
            ...
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='notification_settings', to='api.customuser'),
        ),
        migrations.AlterField(
