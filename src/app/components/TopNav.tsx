...
export function TopNav({ onMenuClick, searchQuery, setSearchQuery }: TopNavProps) {
  ...
  const { syncData, isOfflineMode, pendingSyncCount } = useTaskAPI();
  ...
  return (
    <>
      {/* Static white bar for status bar area on mobile */}
      <div className="fixed top-0 left-0 right-0 h-8 bg-white dark:bg-white z-[60] md:hidden" />
      
      <header className="sticky top-0 z-50 w-full border-b bg-background mt-8 md:mt-0">
      <div className="flex flex-col">
        {/* Top row - Desktop has everything inline, Mobile has logo + actions */}
        <div className="flex h-14 items-center gap-4 px-4">
          ...
          {/* Desktop Search Bar - Inline in center */}
          ...
          <div className="flex items-center gap-2 ml-auto md:ml-0">
            ...
            {/* Manual Refresh Button - Desktop only */}
            <Button
              variant="ghost"
              size="icon"
